...
def main(args):
    ...
    # We use the new OT2Env from ot2_gym_wrapper_2.py
    env = OT2Env(render=False) # Set render=True to watch the training

    # --- Callbacks ---
    # Save a checkpoint of the model every so often.
    ...
    model = PPO(
        ...
        device="gpu"  # Force CPU to avoid CUDA errors
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument("--total_timesteps", type=int, default=50000, help="Total training timesteps (reduced for local training)")
